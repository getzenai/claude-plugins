#!/bin/bash
# List people with optional filtering, ordering, and pagination
# Usage: list.sh [filter] [order_by] [limit] [depth]
# Example: list.sh 'emails.primaryEmail[ilike]:%@example.com' 'createdAt[DescNullsLast]' 50
...
URL="$BASE_URL/rest/people?limit=$LIMIT&depth=$DEPTH"
